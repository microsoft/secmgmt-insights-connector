# Contributing to Security and Management Insights Connector
...
You can file new issues by providing the above information at the [corresponding repository's issues link](https://github.com/microsoft/secmgmt-insights-connector/issues/new).

### Submitting a Pull Request

Before you submit your Pull Request (PR) consider the following guidelines:

- [Search the repository](https://github.com/microsoft/secmgmt-insights-connector/pulls) for an open or closed PR
